...
C {madvlsi/vsource.sym} -200 -40 0 0 {name=Vin
value=0}
C {madvlsi/gnd.sym} -200 -10 0 0 {name=l5 lab=GND}
...
C {devices/code_shown.sym} 200 50 0 0 {name=SPICE only_toplevel=false value=".dc Vin 0 1.8 0.01
.save all"}
C {devices/lab_pin.sym} 130 30 2 0 {name=p2 sig_type=std_logic lab=Vout
}
C {devices/lab_pin.sym} -200 -70 1 0 {name=p3 sig_type=std_logic lab=Vin
}
